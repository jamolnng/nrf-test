...
void ui_watchface_screen_init(void)
{
    ...
    ui_daymonth = lv_label_create(ui_watchface);
    lv_obj_set_width(ui_daymonth, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_daymonth, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_daymonth, 0);
    lv_obj_set_y(ui_daymonth, lv_pct(-21));
    lv_obj_set_align(ui_daymonth, LV_ALIGN_CENTER);
    lv_label_set_text(ui_daymonth, "Sun Jan 01");
    lv_obj_set_style_text_font(ui_daymonth, &ui_font_MesloGLNerdFrontMono14, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_timehhmmss = lv_label_create(ui_watchface);
    ...
    lv_label_set_text(ui_timehhmmss, "00:00:00");
    lv_obj_set_style_text_font(ui_timehhmmss, &ui_font_MesloGLNerdFrontMono38, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_year = lv_label_create(ui_watchface);
    ...
    lv_label_set_text(ui_year, "1970");
    lv_obj_set_style_text_font(ui_year, &ui_font_MesloGLNerdFrontMono14, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_bluetooth = lv_label_create(ui_watchface);
    ...
    lv_obj_set_style_text_font(ui_bluetooth, &ui_font_MesloGLNerdFrontMono28, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_brightness_slider = lv_slider_create(ui_watchface);
